  ...
  <VerticalParallaxSwiper
    ...
    <swiper-slide
      ...
      <div
        ...
        ">
        <!-- 文案 -->
        <div style="text-indent: 2em" class="fs-5">
          <p>
            香龙集团是集生产、开发、销售三位一体的高新技术企业，坐落于人杰地灵的广东省韶关市经济开发区，占地100余亩，工业产房10000平方米。成品与原材料库房15000平方米，年生产能力可达6000吨。
          </p>
          <p>
            以生产开发食品添加剂、天然植物提取物及精细化工产品为主，拥有专利75项，其中旗下长白山科技服务有限公司曾荣获省部级科技进步一等奖。
          </p>
          <p>
            香料集团在全国多地均有原料种植基地，在辅助卷烟减害降焦研究方面成绩斐然，是云南中烟、广东中烟、吉林烟草工业等大型国企多年的供应商，产品广泛应用于食品、烟草、日化、医药等领域。
          </p>
        </div>
        <!-- 图片 -->
        <img
    ...
    <!-- 又一个CountUdp动画 -->
    <swiper-slide
      class="h-100 mb-5 d-flex justify-content-center align-items-center">
      <CountUpData
        ref="CountUpDataEl"
